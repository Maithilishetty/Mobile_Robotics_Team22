...
int main(int argc, char *argv[])
{
    ...
    if(argc < 6)
    {
        cerr << endl << "Usage: ./harbor_test path_to_vocabulary path_to_settings path_to_sequence_folder path_to_times_file output_file [image_enhancement]" << endl;
        return 1;
    }
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        // your viison enhancement function should be within this LoadImages function
        ...
        cout << "tot_images = " << tot_images << endl;
        ...
        while(vTimestampsImu[seq][first_imu[seq]]<=vTimestampsCam[seq][0])
            first_imu[seq]++;
        cout << "first imu count = " << first_imu[seq] <<endl;
